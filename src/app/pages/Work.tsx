...
const projects: Project[] = [
  {
    ...
    year: "2026",
    desc: "An AI-powered financial intelligence platform purpose-built for Indian lenders (KK and similar) to streamline credit analysis, risk scoring, and borrower insights. Currently in active development.",
    features: ["AI-assisted credit analysis", "Borrower risk scoring", "Indian-market data context", "Lender-focused workflow", "Built with React + Motion"],
    liveUrl: "",
    githubUrl: "",
    status: "Case Study",
  },
  ...
  },
  {
    ...
    year: "2026",
    desc: "A wellness-forward brand site for a personal chef — recipes, services, weekly menu CTAs, and a calm green-and-cream palette that signals nourishment. Built on TanStack Start + Cloudflare; Vercel deployment pending.",
