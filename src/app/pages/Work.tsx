...
const projects: Project[] = [
  ...
  {
    id: 8,
    title: "Freakonomics — Essay in Motion",
    tagline: "Cinematic editorial design study",
    category: "Brand",
    tags: ["GSAP", "ScrollTrigger", "Lenis", "Single-file"],
    image: "https://freakonomics-pied.vercel.app/assets/images/book-hero.jpg",
    color: "#C9531A",
    gradient: "linear-gradient(135deg, #C9531A, #F0EAD8)",
    metric: "60fps",
    metricLabel: "Scroll Cinema",
    year: "2026",
    desc: "A sunlit cream editorial reimagining of the Freakonomics book — levitating hero book, letter-by-letter chapter questions, count-up data stats over exploding-page video, and ambient motion on every element. Unofficial concept study built to beat the Stripe Press aesthetic.",
    features: ["Levitating 3D hero book with mouse parallax", "Letter-by-letter scroll reveals", "Count-up stats over video", "Custom cursor + film grain", "Pure HTML/CSS/JS — zero build"],
    liveUrl: "https://freakonomics-pied.vercel.app",
    githubUrl: "",
    status: "Live",
  },
  {
